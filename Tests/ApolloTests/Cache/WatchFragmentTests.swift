...
class WatchFragmentTests: XCTestCase, CacheDependentTesting {
  enum Types {
    static let Weapon = Object(typename: "Weapon", implementedInterfaces: [])
  }

  struct WeaponFragment: MockMutableRootSelectionSet, Fragment {
    ...
    var asRanged: AsRanged? {
      get { _asInlineFragment() }
      set { if let newData = newValue?.__data._data { __data._data = newData }}
    }

    struct AsRanged: MockMutableInlineFragment {
      public var __data: DataDict = .empty()
      public typealias RootEntityType = WeaponFragment
      static let __parentType: ParentType = Types.Weapon
      init(_dataDict: DataDict) { __data = _dataDict }

      static var __selections: [Selection] { [
        .field("range", Double.self),
      ] }

      var primaryFunction: Double {
        get { __data["range"] }
        set { __data["range"] = newValue }
      }
    }
  }
  ...
  func testRefetchWatchedQueryFromServerThroughWatcherReturnsRefetchedResults() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<SimpleMockSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "name": "R2-D2",
  ...
  func testWatchedQueryDoesNotRefetchAfterSameQueryWithDifferentArgument() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<GivenMockSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "name": "R2-D2",
  ...
  func testWatchedQueryGetsUpdatedWhenOverlappingQueryReturnsChangedData() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<HeroAndFriendsNameSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "name": "R2-D2",
    ...
    runActivity("Fetch overlapping query from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<HeroNameSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "name": "Artoo",
  ...
  func testListInWatchedQueryGetsUpdatedByListOfKeysFromOtherQuery() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation = server.expect(MockQuery<HeroAndFriendsNameSelectionSet>.self) { _ in
        [
          "data": [
            "hero": [
              "id": "2001",
    ...
    runActivity("Fetch other query with list of updated keys from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<HeroAndFriendsIdsSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "id": "2001",
  ...
  func testWatchedQueryRefetchesFromServerAfterOtherQueryUpdatesListWithIncompleteObject() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<HeroAndFriendsNameWithIDsSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "id": "2001",
    ...
    runActivity("Fetch other query with list of updated keys from server") { _ in
      ...
      wait(
        for: [serverRequestExpectation, otherFetchCompletedExpectation, refetchServerRequestExpectation, updatedWatcherResultExpectation],
  ...
  func testWatchedQueryGetsUpdatedWhenObjectIsChangedByDirectStoreUpdate() throws {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation =
        server.expect(MockQuery<HeroAndFriendsNamesSelectionSet>.self) { _ in
          [
            "data": [
              "hero": [
                "name": "R2-D2",
  ...
  func testWatchedQuery_givenCachePolicyReturnCacheDataDontFetch_doesNotRefetchFromServerAfterOtherQueryUpdatesListWithIncompleteObject() throws {
    ...
    runActivity("Fetch other query with list of updated keys from server") { _ in
      let serverRequestExpectation = server.expect(MockQuery<HeroAndFriendsIDsOnlySelectionSet>.self) { _ in
        [
          "data": [
            "hero": [
              "id": "2001",
  ...
  func testWatchedQueryDependentKeysAreUpdatedAfterDirectStoreUpdate() {
    ...
    runActivity("Initial fetch from server") { _ in
      let serverRequestExpectation = server.expect(HeroAndFriendsNamesWithIDsQuery.self) { _ in
        [
          "data": [
            "hero": [
              "id": "2001",
